...
def print_modernization_summary():
    ...
    try:
        ...
        print("      • Legacy pandas code:  Deprecated (moved to pipelines/deprecated/)")
        print("      • Architecture:        Consolidated and optimized")
