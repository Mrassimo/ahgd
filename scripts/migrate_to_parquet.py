...
class SQLiteToParquetMigrator:
    ...
    def migrate_table(self, table_name: str) -> dict[str, any]:
        ...
        try:
            ...
            logger.error(f"❌ Failed to migrate table {table_name}: {e!s}")
    ...
    def _print_migration_summary(self, successful: list[dict], failed: list[dict]):
        ...
        print("   • Analytics:       Column-oriented optimization")
        print("   • Compatibility:   Works with all Polars/DuckDB tools")
