...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[
            ...
            logging.FileHandler('logs/health_pipeline_test.log')
        ]
    )
...
def test_health_data_extraction():
    ...
    try:
        ...
        try:
            from src.models.health import MBSRecord, PBSRecord, AIHWMortalityRecord, PHIDUChronicDiseaseRecord, ServiceType, AgeGroup, Gender, CauseOfDeath, ChronicDiseaseType
        ...
        try:
            from src.utils.geographic import GeographicMatcher, PopulationWeighter
            ...
            for geo_id, expected_type in test_cases:
                ...
                if detected_type == expected_type:
                    ...
                    logger.warning(f"⚠️ Geographic type detection: {geo_id} expected {expected_type}, got {detected_type}")
            
            # Test population weighter
            weighter = PopulationWeighter()
            test_weights = weighter.calculate_weights(['12345678901', '12345678902'], method='equal')
        ...
        try:
            from pipelines.dlt.health import (
                _classify_service_type, _map_age_group, _map_gender, 
                _map_cause_of_death, _extract_disease_type
            )
...
def run_integration_test():
    ...
    try:
        ...
        mock_mbs_data = pd.DataFrame({
            ...
            'mbs_item_description': ['GP Consultation', 'Health Assessment', 'Specialist Consultation'],
...
def performance_benchmark():
    ...
    try:
        ...
        total_records = estimated_mbs_records + estimated_pbs_records + estimated_mortality_records + estimated_phidu_records
        ...
        logger.info(f"   - Memory usage estimate: ~2-4 GB peak")
...
def main():
    ...
    if all_passed:
        ...
        print("2. Execute health data extraction: pipelines/orchestrator.py --pipeline health_services")
