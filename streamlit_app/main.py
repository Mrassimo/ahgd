...
class AHGDDashboard:
    ...
    def render_header(self):
        ...
        with col2:
            st.markdown(
                '<h1 class="main-header">🏥 AHGD V3: Health Analytics</h1>', unsafe_allow_html=True
            )
    ...
    def render_sidebar(self):
        ...
        enable_realtime = st.sidebar.checkbox(
            "🔄 Real-time Updates", value=False, help="Enable automatic data refresh"
        )
    ...
    def render_main_content(self, filters):
        ...
        tab1, tab2, tab3, tab4 = st.tabs(
            ["🗺️ Interactive Map", "📊 Health Metrics", "📈 Trends Analysis", "📤 Data Export"]
        )
