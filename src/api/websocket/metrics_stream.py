...
from ..models.common import MetricValue, SystemHealth, QualityScore
from ..models.responses import MetricsStreamResponse
from .connection_manager import ConnectionManager, SubscriptionType
...
class MetricsStreamer:
                ...
                metrics_response = MetricsStreamResponse(
                    ...
                    metrics=[
                        ...
                        MetricValue(
                            ...
                            value=quality_score.completeness,
                            unit="%"
                        ),
                        MetricValue(
                            name="quality_accuracy",
                            value=quality_score.accuracy, 
                            unit="%"
                        )
                    ],
    ...
    def _generate_metric_value(
        ...
        variance_adjustment = random.uniform(
            -generator.variance / 2, 
            generator.variance / 2
        )
    ...
    def _determine_system_status(self) -> str:
        ...
        if (cpu_usage > 90 or memory_usage > 90 or 
            error_rate > 8 or quality_score < 75):
            return "critical"
        elif (cpu_usage > 75 or memory_usage > 80 or 
              error_rate > 5 or quality_score < 85):
            return "warning"
        else:
            return "healthy"
