...
from ..models.responses import WebSocketResponse, SubscriptionResponse
from ..models.common import MetricValue, SystemHealth
...
class ConnectionManager:
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        active_subscriptions_by_type = {
            ...
            for sub_type, sub_ids in self.subscription_by_type.items()
        }
        ...
        while self._running:
            try:
                ...
                if ping_tasks:
                    ...
                    failed_pings = sum(1 for result in results if result is False or isinstance(result, Exception))
        ...
        while self._running:
            try:
                ...
                for conn_id in unhealthy_connections:
                    logger.info(
                        "Cleaning up unhealthy connection",
